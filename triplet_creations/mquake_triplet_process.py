...
def process_triplets(
    ...
    """
    logger.info(f"Processing triplets from {triplet_file}")
    ...
    logger.info(f"Loaded {len(raw_triplets)} raw triplets")
    ...
    logger.info(f"Removed {len(raw_triplets) - len(unique_triplets)} duplicate triplets")
    ...
    if handle_inverses:
        ...
        logger.info(f"Identified {len(inverse_relations)} potential inverse relation pairs")
    ...
    logger.info(f"Final processed triplet count: {len(processed_triplets)}")
    ...
    if entity_file or relation_file:
        ...
        logger.info(f"Final entity count: {len(final_entities)}")
        logger.info(f"Final relation count: {len(final_relations)}")
...
def create_dataset_splits(
    ...
    """
    logger.info(f"Creating dataset splits from {processed_triplet_file}")
...
def main():
    ...
    if args.mode in ['expand_entities', 'full_pipeline']:
        ...
        logger.info(f"Saved {len(expanded_triplets)} expanded entities to {args.expanded_triplet_output}")
    ...
    if args.mode == 'full_pipeline':
        ...
        logger.info(f"- Expanded entity set: {args.expanded_entity_output}")
        logger.info(f"- Relations: {args.og_relation_output}")
        logger.info(f"- Raw triplets: {args.raw_triplet_output}")
        logger.info(f"- Processed triplets: {args.processed_triplet_output}")
        logger.info(f"- Training set: {args.train_output}")
        logger.info(f"- Test set: {args.test_output}")
        logger.info(f"- Validation set: {args.valid_output}")
